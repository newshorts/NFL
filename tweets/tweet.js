...
(function (factory) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      ...
      template_tweet: "{join} {text}",  // [string or function] template used to construct each tweet <li> - see code for available vars
    ...
    $.fn.extend({
      linkUser: replacer(/(^|[\W])@(\w+)/gi, "<a class='at_user' href=\"http://"+s.twitter_url+"/$2\">@$2</a>"),
    ...
    function linkURLs(text, entities) {
      return text.replace(url_regexp, function(match) {
        ...
        return "<a href=\""+escapeHTML(url)+"\" class='external_link'>"+escapeHTML(text)+"</a>";
      });
    }
    ...
    function build_api_url() {
      ...
      if (s.list) {
        ...
        return proto+'//'+s.twitter_search_url+'/search/tweets.json?q='+encodeURIComponent(query)+'&rpp='+count+'&page='+s.page+common_params;
      }
    }
...
//============   POTENTIALLY UNUSED =============//
      ...
      o.username = t('<a class="user_name" href="{user_url}">{username}</a>', o);
