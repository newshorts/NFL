...
function gplus_count(){
    ...
    if ($count !== false) return $count;
         $count = 0;
        $data = file_get_contents('http://widgetsplus.com/google_plus_widget.php?pid=104656794030246253715&host=http://sfsuperbowl.com');
   if (is_wp_error($data)) {
         return 'whoa error!!!';
   }else{
...
set_transient('gplus_count', $count, 60*60*01); // 72 hour cache
return $count;
}
...
function twitter_count(){
    ...
    if ($count !== false) return $count;
         $count = 0;
         $dataOrig = file_get_contents('https://twitter.com/FastmanSS');
